import svgPaths from "./svg-j08cokkn8v";
...
function LoginScreenFigma() {
  return (
    <div className="absolute content-stretch flex h-[962px] items-center justify-center left-0 top-0 w-[1417px]" data-name="LoginScreenFigma">
      <Container7 />
    </div>
  );
}
